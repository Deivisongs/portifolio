...
import Paises from "../../../img/BuscaPaises.svg";
  ...
  const [projetos] = useState([
    {
      ...
      title: "Banco Online...",
      descript:
        "Nesse Projeto crio um simulador de Saque e depósito de dinheiro",
      skill1: null,
      skill2: null,
      skill3: null,
    ...
    {
      id: "1",
      linkImg: "https://stalwart-kitten-3e69ca.netlify.app/",
      image: Paises,
      title: "Dados API",
      descript:
        "Nesse pequeno projeto peguei os dados de uma API e mostrei em uma tabela",
      skill1: <TagSkill image={Html} text="HTML" />,
      skill2: <TagSkill image={Css} text="CSS" />,
      skill3: <TagSkill image={Js} text="JavaScript" />,
      skill4: null,
      projeto: "https://stalwart-kitten-3e69ca.netlify.app/",
      github: "https://github.com/Deivisongs/Paises-puxados-de-API",
    },
  ]);
  function mudaMais() {
